...
TEMPLATES = {
    ...
    "patient_referral_notice": {
        "sms": "ارجاع بیماران شما به درمانگر جایگزین ثبت شد. کمیته نظارت اطلاع‌رسانی کرده است.",
    },
    "patient_referral_therapist_notice": {
        "sms": "بیمار ارجاع‌شده به شما تخصیص یافت. لطفاً در پورتال درمانگر پیگیری کنید.",
    },
    "return_reminder": {
    ...
    # آماده‌سازی ترم — دست‌به‌دست نقش بعدی
    "calendar_submitted_tuition_needed": {
        "in_app": "تقویم آموزشی دو ترم ثبت شد. لطفاً شهریه و هزینهٔ مصاحبه را در میز کار آماده‌سازی ترم تکمیل کنید.",
    },
    "license_reviewed_course_list_needed": {
        "in_app": "بررسی پروانه انجام شد. لطفاً لیست دروس، مدرسین و کمک‌مدرسین را در میز کار آماده‌سازی ترم تکمیل کنید.",
    },
    "courses_finalized_start_marketing": {
        "in_app": "برنامهٔ دروس نهایی شد. لطفاً شروع کمپین بازاریابی پذیرش را در میز کار آماده‌سازی ترم تأیید کنید.",
    },
    "marketing_started_set_interviewers": {
        "in_app": "کمپین بازاریابی آغاز شد. لطفاً مصاحبه‌گرها و زمان‌بندی مصاحبه را در میز کار آماده‌سازی ترم ثبت کنید.",
    },
    "interviewers_set_schedule_times": {
        "in_app": "مصاحبه‌کنندگان تعیین شدند. لطفاً اسلات‌های مصاحبه را در میز کار آماده‌سازی ترم تکمیل کنید.",
    },
    "winter_license_reviewed_review_courses": {
        "in_app": "بررسی پروانهٔ زمستان انجام شد. لطفاً لیست دروس زمستان را در میز کار بازبینی کنید.",
    },
    "winter_courses_finalized_start_marketing": {
        "in_app": "برنامهٔ دروس زمستان نهایی شد. لطفاً کمپین بازاریابی زمستان را در میز کار تأیید کنید.",
    },
    "winter_marketing_started_set_interviewers": {
        "in_app": "کمپین بازاریابی زمستان آغاز شد. لطفاً مصاحبه‌گرها و زمان‌بندی را در میز کار ثبت کنید.",
    },
    "winter_interviewers_set_schedule_times": {
        "in_app": "مصاحبه‌کنندگان زمستان تعیین شدند. لطفاً اسلات‌های مصاحبه را در میز کار تکمیل کنید.",
    },
    "academic_calendar_published": {
        "in_app": "تقویم آموزشی ترم منتشر شد. جزئیات را در پروفایل و تقویم آموزشی ببینید.",
        "sms": "دانشجوی محترم\nموضوع: مهلت ثبت نام\nبه اطلاع میرسانیم که مهلت ثبت نام برای ترم پاییز اعلام شد. برای ثبت نام به سامانه مراجعه کنید.\nمسئول هماهنگی ها\n۰۲۱۲۲۷۲۸۰۰۰\nداخلی ۱",
    },
    "winter_calendar_published": {
        "in_app": "تقویم آموزشی ترم زمستان منتشر شد. جزئیات را در پروفایل و تقویم آموزشی ببینید.",
        "sms": "دانشجوی محترم\nموضوع: مهلت ثبت نام\nبه اطلاع میرسانیم که مهلت ثبت نام برای ترم زمستان اعلام شد. برای ثبت نام به سامانه مراجعه کنید.\nمسئول هماهنگی ها\n۰۲۱۲۲۷۲۸۰۰۰\nداخلی ۱",
    },
    ...
    "tuition_payment_to_accounting": {
        "sms": (
            "همکار گرامی\n"
            "در پورتال حسابداری یک تراکنش جدید بابت شهریه توسط دانشجو {student_name} "
            "به مبلغ {amount} ثبت گردید. لطفاً جهت ثبت نهایی در سیستم حسابداری اقدام فرمایید.\n"
            "اتوماسیون انستیتو"
        ),
    },
