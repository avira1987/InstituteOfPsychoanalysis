...
export const CONTEXT_KEY_LABELS = {
  ...
  per_unit_cost_introductory: 'هزینه هر واحد دوره آشنایی (ریال)',
  ...
  registration_interview_fee_rial: 'هزینه مصاحبه ثبت‌نام — پشتیبان (ریال)',
  registration_tuition_invoice_toman: 'شهریه / فاکتور ثبت‌نام — پشتیبان (تومان)',
  start_therapy_first_session_fee_rial: 'اولین جلسه درمان آموزشی (ریال)',
  extra_session_fee_rial: 'جلسه اضافه درمان (ریال)',
  default_therapy_session_fee_toman: 'پیش‌فرض هر جلسه درمان آموزشی (تومان)',
  ...
  introductory_date_range_start: 'شروع بازه مصاحبه دوره آشنایی',
  introductory_date_range_end: 'پایان بازه مصاحبه دوره آشنایی',
