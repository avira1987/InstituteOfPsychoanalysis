...
export const PORTAL_ROLE_HOME = {
  ...
  faculty_1: { path: '/panel/portal/supervisor', tasksTab: 'reviews' },
  ...
  educational_instructor: { path: getStaffLanePath('instruction'), tasksTab: 'pending' },
  instructor: { path: getStaffLanePath('instruction'), tasksTab: 'pending' },
