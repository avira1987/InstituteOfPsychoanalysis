...
export const COMMITTEE_ROLE_CONFIG = {
  ...
  education_committee: {
    ...
    reviewKeywords: ['education_committee', 'education_review', 'final_verdict', 'continuation_review', 'committees_review', 'interview_scheduling', 'therapist_committee'],
    assignedRoles: ['education_committee'],
  },
  supervision_committee: {
    title: 'پنل کمیته نظارت',
    subtitle: 'بررسی موارد انضباطی، هشدارهای تخلف و توصیه‌ها',
    icon: '🔍',
    ...
    assignedRoles: ['supervision_committee', 'monitoring_committee_officer'],
  },
  ...
  therapy_committee_chair: {
    title: 'پنل کمیته درمان',
    subtitle: 'واگذاری پیگیری، مشاهده موارد عدم حضور و ثبت گزارش',
    icon: '🏥',
    ...
    assignedRoles: ['therapy_committee_chair', 'therapy_committee_executor'],
  },
