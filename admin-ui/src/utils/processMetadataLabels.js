...
export const STUDENT_TASK_LABELS_FA = {
  ...
  "therapy_blocked": "شما درمانگر فعالی ندارید و امکان ثبت‌نام شما برای ترم دوم ممکن نیست. از فرایند «آغاز درمان آموزشی» در پورتال اقدام کنید تا مسدودیت برداشته شود.",
  ...
  "therapy_check_failed": "شما درمانگر فعالی ندارید و امکان ثبت‌نام شما برای ترم دوم ممکن نیست.",
...
export const PROCESS_STUDENT_TASK_LABELS_FA = {
  ...
  "introductory_course_registration": {
    ...
    "course_selection": "دروس مجاز را در فرم همین صفحه انتخاب و ثبت کنید؛ سپس دکمهٔ ادامه را بزنید.",
    "payment": "روش پرداخت را در فرم همین صفحه انتخاب کنید؛ سپس شهریه را از بخش پرداخت سپ بپردازید و صفحه را تازه کنید.",
    "registration_complete": "ثبت‌نام نهایی شد. گام بعدی بسته به نوع پذیرش شماست (تک‌درس: ادامه از پنل دروس؛ مشروط: آغاز درمان تا قبل از ترم دوم؛ پذیرش کامل: آغاز درمان آموزشی). اگر مسیر اصلی پرتال به‌روز نشد، داشبورد را تازه کنید.",
    "installment_overdue": "قسط معوق را از بخش پرداخت سپ همین صفحه بپردازید؛ پس از بازگشت از بانک، صفحه را تازه کنید."
  },
  "introductory_term_end": {
  ...
  "start_therapy": {
    ...
    "already_completed": "شما قبلاً آغاز درمان آموزشی را تکمیل کرده‌اید. اگر نیاز به پشتیبانی دارید، تیکت ثبت کنید یا با پذیرش تماس بگیرید.",
    "therapist_selection": "از شیت وقت‌های آزاد (ثبت‌شده توسط کمیته نظارت) درمانگر و برنامهٔ جلسات را انتخاب کنید؛ سپس ادامه دهید تا تاریخ شروع محاسبه و به پرداخت جلسهٔ اول بروید. در دوره آشنایی این انتخاب الزام فوری ترم اول نیست؛ اگر پذیرش مشروط دارید، تا قبل از ثبت‌نام ترم دوم باید این فرایند را تکمیل کنید وگرنه ثبت‌نام ترم دوم بسته می‌شود.",
...
export const OPERATOR_TASK_LABELS_FA = {
  ...
  "interviewer_assignment": "مصاحبه‌گرها و زمان‌بندی را ثبت کنید.",
