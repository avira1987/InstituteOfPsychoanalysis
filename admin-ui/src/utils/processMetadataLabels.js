...
export const PROCESS_STATE_LABELS_FA = {
  ...
  "group_supervision_course_completion": {
    ...
    "session_18_pass_fail_entry": "ثبت Pass/Fail (جلسه ۱۸)",
    "pass_fail_applied": "اعمال ساعات بالینی",
  ...
  "return_to_full_education": {
    ...
    "therapy_24h_scheduled": "محاسبه تاریخ شروع درمان",
    "therapy_payment_pending": "پرداخت جلسه اول درمان",
    "therapy_completed": "درمان آموزشی بازگشایی شد",
    "supervisor_selection": "انتخاب سوپروایزر",
    "supervision_24h_scheduled": "محاسبه تاریخ شروع سوپرویژن",
    "supervision_payment_pending": "پرداخت جلسه اول سوپرویژن",
    "registration_unlocked": "ثبت‌نام دروس باز شد",
    "return_complete": "بازگشت تکمیل شد",
    "return_rejected": "بازگشت رد شد"
  },
  "session_payment": {
    "payment_due": "مبلغ قابل پرداخت",
...
export const PROCESS_STUDENT_TASK_LABELS_FA = {
  ...
  "attendance_tracking": {},
  "class_attendance": {
    "attendance_list_ready": "مدرس در حال ثبت حضور این جلسه است. شمارندهٔ غیبت شما در همین درس در داشبورد «وضعیت دروس» نمایش داده می‌شود.",
    "session_recorded": "حضور یا غیبت شما در این جلسه ثبت شد. جدول جلسات در همین کارت به‌روز می‌شود.",
    "incomplete_triggered": "با ۵ غیبت، وضعیت Incomplete و قفل نمره برای این درس اعمال شده است. با مدرس و پذیرش هماهنگ کنید.",
    "article_violation_reported": "غیبت‌های شما در درس مقاله‌نویسی به کمیته نظارت گزارش شده است. وضعیت Incomplete اعمال نمی‌شود."
  },
  "class_session_cancellation": {},
  "committees_review": {},
  "comprehensive_course_registration": {
  ...
  "film_observation_ta_attendance_completion": {},
  "full_education_leave": {
    "leave_request": "مدت مرخصی (۱ یا ۲ ترم) را انتخاب و درخواست را ارسال کنید.",
    "session_scheduled": "زمان و نحوهٔ برگزاری جلسه در همین صفحه نمایش داده می‌شود؛ در روز مقرر طبق اعلام کمیته حاضر شوید.",
    "committee_decision": "منتظر ثبت نتیجهٔ نهایی جلسه توسط کمیته پیشرفت باشید.",
    "therapist_assignment": "در صورت تمایل به ادامه درمان، ظرف ۳ روز با مسئول هماهنگی‌ها تماس بگیرید.",
    "on_leave": "برای بازگشت، فرایند «بازگشت به کل آموزش» (فرایند ۶۰) را آغاز کنید.",
    "return_reminder_sent": "مهلت بازگشت فرا رسیده است. فرایند ۶۰ را آغاز و تکمیل کنید.",
    "leave_rejected": "شرح توافقات در همین صفحه نمایش داده می‌شود."
  },
  "group_supervision_course_completion": {},
  "internship_12month_conditional_review": {},
  "internship_readiness_consultation": {
  ...
  "live_therapy_observation_course_completion": {},
  "live_therapy_observation_session_prep": {
    "patient_referral": "فرم ارجاع بیمار را تکمیل و ثبت کنید؛ سپس دکمهٔ ارجاع به مسئول هماهنگی را بزنید.",
    "coordination_pending": "پس از هماهنگی چهارجانبه، فرم زمان/مدرس/درمانگر را ثبت کنید؛ سپس «ثبت قطعی در LMS» یا در صورت عدم توافق «وقت هماهنگ نشد».",
    "session_scheduled": "جلسه ثبت شد؛ پیامک به ارکان آموزشی ارسال شده است.",
    "coordination_closed": "پرونده هماهنگی مختومه شد."
  },
  "live_therapy_observation_ta_attendance_completion": {},
  "mentor_private_sessions": {
    "instructor_click": "تاریخ و ساعت هر دو جلسهٔ تدریس خصوصی را در فرم زیر وارد کنید؛ پس از ذخیرهٔ فرم، دکمهٔ «ثبت جلسات» را بزنید. مهلت: پیش از شروع جلسهٔ دوم کلاس.",
    "sessions_registered": "جلسات ثبت شد؛ سامانه اطلاع‌رسانی و یادآوری ۲۴ ساعته را انجام می‌دهد.",
    "process_complete": "ثبت نهایی انجام شد؛ جزئیات جلسات در پورتال کمک‌مدرس قابل مشاهده است.",
    "deadline_missed": "مهلت ثبت گذشته است؛ این مورد به‌عنوان تخلف ثبت و به کمیتهٔ نظارت ارجاع می‌شود."
  },
  "patient_referral": {},
  "process_merged_to_one": {},
  "return_to_full_education": {
    "return_request": "برای بازگشت به کل آموزش، دکمهٔ ادامه را بزنید تا به انتخاب درمانگر آموزشی بروید.",
    "therapist_selection": "درمانگر آموزشی و تعداد جلسات هفتگی را در فرم مشخص کنید (جامع: ۲ ساعت؛ آشنایی: ۱–۲ ساعت). سپس دکمهٔ ادامه را بزنید.",
    "therapy_24h_scheduled": "تاریخ شروع درمان بر اساس قانون ۲۴ ساعت محاسبه می‌شود. چند ثانیه صبر کنید و صفحه را تازه کنید.",
    "therapy_payment_pending": "هزینهٔ جلسهٔ اول درمان را از درگاه بانک همین صفحه بپردازید. پس از تأیید بانک صفحه را تازه کنید.",
    "therapy_completed": "درمان آموزشی ثبت شد. در صورت انترن بودن، مرحلهٔ انتخاب سوپروایزر باز می‌شود.",
    "supervisor_selection": "سوپروایزر و زمان جلسه (۱ ساعت در هفته) را در فرم انتخاب کنید؛ سپس دکمهٔ ادامه را بزنید.",
    "supervision_24h_scheduled": "تاریخ شروع سوپرویژن محاسبه می‌شود. چند ثانیه صبر کنید.",
    "supervision_payment_pending": "هزینهٔ جلسهٔ اول سوپرویژن را از درگاه بانک همین صفحه بپردازید.",
    "registration_unlocked": "ثبت‌نام دروس ترم جدید برای شما باز شده است.",
    "return_complete": "بازگشت به کل آموزش با موفقیت تکمیل شد."
  },
  "session_payment": {
    "payment_due": "دکمهٔ «ادامه به انتخاب جلسات و تسویه» را بزنید. اگر بدهی جلسهٔ قبلی دارید، در مرحلهٔ بعد آن را همراه پرداخت انتخاب کنید.",
    "payment_selection": "فرم همین صفحه را تکمیل کنید؛ در صورت بدهی، گزینهٔ تسویه را فعال کنید. سپس دکمهٔ «ادامه و ثبت مرحله» را بزنید تا به درگاه هدایت شوید.",
  ...
  "student_instructor_evaluation": {
    "evaluation_open": "فهرست دروس این ترم را ببینید و برای هر درس جداگانه ارزیابی ناشناس ثبت کنید. تکمیل فرم اختیاری است."
  },
  "student_non_registration": {
    "meeting_scheduled": "زمان و نحوهٔ برگزاری جلسه در همین صفحه نمایش داده می‌شود؛ در روز مقرر طبق اعلام کمیته حاضر شوید.",
    "branch_register": "حداکثر ۲ روز فرصت دارید دروس ترم را اخذ و شهریه را پرداخت کنید. از بخش ثبت‌نام ترم در همین پنل اقدام کنید.",
  ...
  "ta_student_consultation": {},
  "ta_to_assistant_faculty": {
    "supervision_review": "پرونده در کمیته نظارت در حال بررسی است؛ پس از اعلام نتیجه همین صفحه را تازه کنید.",
    "supervision_rejected": "صلاحیت تأیید نشد. برای ترم‌های بعد می‌توانید «درخواست ارزیابی مجدد» را بزنید.",
    "upgrade_applied": "ارتقا با موفقیت اعمال شد.",
    "already_assistant": "شما قبلاً رتبهٔ تحلیلی دستیار هیئت علمی را اخذ کرده‌اید.",
  },
  "ta_to_instructor_auto": {},
  "ta_track_change": {
    "ta_click": "پس از هماهنگی با مدرس، مسیر را در فرم انتخاب کنید و «ارسال درخواست» را بزنید.",
    "path_selected": "درخواست به کمیته دروس ارسال شد؛ منتظر تعیین وقت جلسه باشید.",
    "course_committee_review": "کمیته دروس در حال ثبت زمان جلسه است.",
    "meeting_scheduled": "جلسه برنامه‌ریزی شده — جزئیات زمان را در پنل بالا ببینید.",
  ...
  "upgrade_to_ta": {
    "student_click": "چهار شرط ارتقا را بررسی کنید؛ در صورت احراز همهٔ شروط، «ادامه و ثبت مرحله» را بزنید.",
    ...
    "commitment_signature": "تعهدنامه را بپذیرید و با کد پیامکی امضا کنید.",
    "conditions_not_met": "شرایط ارتقا احراز نشده است.",
    "supervision_rejected": "صلاحیت توسط کمیته نظارت تأیید نشد.",
    "course_committee_rejected": "صلاحیت پس از مصاحبه تأیید نشد.",
    "ta_registered": "ارتقا به کمک‌مدرس تکمیل شد."
  },
  "violation_registration": {
    "violation_reported": "گزارش تخلف ثبت شده و در حال بررسی کمیته نظارت است.",
    "review_status_set": "پرونده در حال بررسی است؛ در صورت دعوت به جلسه، اطلاع‌رسانی می‌شود.",
    "meeting_scheduled": "زمان جلسه کمیته نظارت در همین صفحه نمایش داده می‌شود؛ در روز مقرر حاضر شوید.",
    "verdict_issued": "حکم صادر شده و در جدول گزارش عملکرد قابل مشاهده است. شروط جبرانی را رعایت کنید.",
    "suspension_next_term": "تعلیق از ترم بعد اعمال شده است؛ ثبت‌نام ترم آینده تا اعلام کمیته مسدود است.",
    "suspension_immediate": "تعلیق آنی اعمال شده است؛ حضور در کلاس و سوپرویژن محدود است.",
    "referred_to_education_committee": "پرونده به کمیته آموزش ارجاع شده؛ دعوت‌نامهٔ جلسه آنلاین ارسال می‌شود.",
    "closed": "پرونده مختومه شد.",
    "expelled": "حکم اخراج صادر شده؛ پورتال به حالت فقط‌خواندنی درآمده است."
  },
  "winter_semester_preparation": {}
}
...
export const PROCESS_OPERATOR_TASK_LABELS_FA = {
  ...
  "class_session_cancellation": {
    "cancellation_request": "انتخاب درس و جلسه؛ تأیید هم‌زمان زمان جبرانی (جمعه هفته ۱۵/۱۶)."
  },
  "committees_review": {
    "supervision_review": "بررسی/صدور مجوز طبق دستور کار.",
    "education_review": "بررسی پرونده در جلسه کمیته آموزش."
  ...
  "full_education_leave": {
    ...
    "deputy_alerted": "ثبت فوری جلسه پس از هشدار SLA.",
    "session_scheduled": "پس از برگزاری جلسه، نتیجه را ثبت کنید.",
    "committee_decision": "تأیید یا رد درخواست مرخصی از کل آموزش.",
    "therapist_assignment": "تعیین تکلیف وقت درمانگر (مهلت ۴ روز)."
  },
  "group_supervision_course_completion": {
    "session_18_pass_fail_entry": "Pass/Fail هر دانشجو را تا ۲۴:۰۰ جلسه ۱۸ ثبت کنید.",
    "ta_evaluation_entry": "نمره حضور و وظایف کمک‌مدرس را ثبت کنید (≥ ۷۴ PASS).",
    "qualitative_eval_pending": "فرم ارزیابی کیفی (سوال ۷ و ۸) را ظرف ۴ روز تکمیل کنید."
  },
  "internship_12month_conditional_review": {
    "supervision_review": "بررسی/صدور مجوز طبق دستور کار.",
  ...
  "live_supervision_course_completion": {
    "sessions_in_progress": "ثبت حضور دوگانه در هر جلسه؛ پیگیری ۱۵ عادی + ۳ پشت‌آینه.",
    "mirror_implementation_pending": "فرم پیاده‌سازی جلسه پشت‌آینه را تکمیل کنید (۵ روز).",
    "mirror_eval_pending": "فرم ارزیابی ۳ جلسه پشت‌آینه را تکمیل کنید (۵ روز).",
    "final_eval_pending": "فرم ارزیابی نهایی کیفی (سوال ۷ و ۸) را تا ۲۴:۰۰ تکمیل کنید."
  },
  "live_supervision_session_prep": {
    "patient_referral": "بررسی مدارک/پرونده؛ تأیید، نقص، یا ادامه.",
    "coordination_pending": "هماهنگی آموزش درمان و ثبت اطلاعات."
  ...
  "live_therapy_observation_session_prep": {
    ...
    "coordination_pending": "هماهنگی چهارجانبه و ثبت زمان قطعی در LMS یا ختم پرونده."
  },
  "live_therapy_observation_ta_attendance_completion": {
    "grades_entry": "ثبت نمره/حضور/تأیید TA."
  },
  "mentor_private_sessions": {
    "instructor_click": "تاریخ و ساعت دو جلسهٔ تدریس خصوصی با کمک‌مدرس را ثبت کنید.",
    "sessions_registered": "منتظر اطلاع‌رسانی سیستمی بمانید.",
    "process_complete": "پرونده نهایی شد.",
    "deadline_missed": "تخلف — عدم ثبت تا جلسه دوم."
  },
  "patient_referral": {
    "patients_listed": "بررسی گزارش و ثبت اقدام.",
  ...
  "session_payment": {},
  "skills_course_completion": {
    "awaiting_session_17": "منتظر باز شدن فیلدها در جلسه ۱۷.",
    "session_17_grades_entry": "مشارکت (۰–۱۰) و امتحان عملی را برای هر دانشجو ثبت کنید. مهلت: ۲۴:۰۰ همان روز.",
    "awaiting_session_18": "نمرات جلسه ۱۷ ثبت شد — منتظر جلسه ۱۸.",
    "session_18_grades_entry": "نمره آزمون تستی را ثبت کنید. حضور خودکار محاسبه می‌شود.",
    "grades_computed": "نمرات نهایی محاسبه شد.",
    "ta_evaluation_entry": "نمره حضور و وظایف کمک‌مدرس را ثبت کنید.",
    "qualitative_eval_pending": "فرم ارزیابی کیفی (سوال ۷ و ۸) را ظرف ۴ روز تکمیل کنید.",
    "grades_locked": "نمرات قفل شد.",
    "session_17_delay": "مهلت جلسه ۱۷ گذشته — گزارش به کمیته.",
    "qualitative_eval_delay": "تأخیر ارزیابی کیفی — گزارش تخلف."
  },
  "specialized_commission_review": {
    "commission_review": "بررسی پرونده و ثبت رأی."
  ...
  "ta_to_instructor_auto": {
    "end_of_term_check": "بررسی خودکار پایان ترم — اقدام دستی لازم نیست.",
    "conditions_not_met": "شرایط احراز نشد — گزارش اطلاع‌رسانی صادر نمی‌شود.",
    "upgrade_applied": "گزارش خودکار ارتقا — فقط مشاهده؛ تأیید دستی لازم نیست."
  },
  "ta_track_change": {
    "ta_click": "هماهنگی با مدرس؛ ثبت اطلاعات یا تأیید درخواست.",
    "course_committee_review": "بررسی علمی و ثبت نظر.",
  ...
  "theory_course_completion": {
    ...
    "final_exam_open": "آزمون تستی برای دانشجویان باز است.",
    "grades_computed": "نمرات نهایی محاسبه شد.",
    "borderline_student_choice": "دانشجو در حال انتخاب امتحان مجدد یا دوباره گذراندن درس است.",
    "retake_exam_open": "امتحان مجدد فعال است.",
    "qualitative_eval_pending": "فرم ارزیابی کیفی (سوال ۷ و ۸) را ظرف ۴ روز تکمیل کنید.",
    "grades_locked": "نمرات قفل شد.",
    "session_18_delay": "مهلت جلسه ۱۸ گذشته — گزارش به کمیته.",
    "qualitative_eval_delay": "تأخیر ارزیابی کیفی — گزارش تخلف."
  },
  "therapist_session_cancellation": {
