...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'برای اکثر کاربران ورود با شماره موبایل و کد یکبار مصرف پیامکی است؛ کد تازه درخواست کنید. کاربران پرسنلی که ورود با نام کاربری و رمز دارند، از مسیر «ورود با رمز عبور» و در صورت نیاز پشتیبانی انیستیتو کمک بگیرند.',
  },
  {
    ...
    <>
      <div className="pub-page-header">
        ...
        <p>
          ...
          برای فهرست فرآیندها و مراحل، صفحه{' '}
          <Link to="/processes-info">فرآیندها و مراحل آموزشی</Link>
          {' '}را ببینید.
        </p>
      </div>
      ...
      <section className="pub-section" style={{ paddingTop: 0 }}>
        <div className="pub-cta">
          ...
          <p>با تکمیل فرم ثبت‌نام، اولین قدم را بردارید — یا پیش از آن فرآیندها را در سامانه ببینید</p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', justifyContent: 'center' }}>
            <Link to="/register" className="pub-cta-btn">
              شروع ثبت‌نام
            </Link>
            <Link to="/processes-info" className="pub-cta-btn" style={{ background: 'transparent', border: '2px solid currentColor' }}>
              فرآیندها و مراحل
            </Link>
          </div>
        </div>
