              ...
              <div className="guide-steps">
                <div className="guide-step">
                  ...
                  <div className="guide-step-content">
                    ...
                    <p>آدرس سامانه را در مرورگر خود وارد کنید. صفحه ورود نمایش داده می‌شود.</p>
                  </div>
                </div>
                <div className="guide-step">
                  <div className="guide-step-number">2</div>
                  <div className="guide-step-content">
                    <h4>وارد کردن نام کاربری و رمز عبور</h4>
                    <p>
                      نام کاربری و رمز عبوری که از مدیر سیستم دریافت کرده‌اید را وارد کنید و دکمه «ورود» را بزنید.
                    </p>
                  </div>
                </div>
                <div className="guide-step">
                  ...
                  <div className="guide-step-content">
                    <h4>ورود به داشبورد</h4>
                    <p>
                      پس از ورود موفق، داشبورد اصلی نمایش داده می‌شود که شامل آمار کلی سیستم و لیست فرایندهای تعریف‌شده است.
                    </p>
                  </div>
                </div>
              </div>
