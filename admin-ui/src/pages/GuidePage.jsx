            ...
            <section id="student_path" className="guide-section">
              ...
              <div className="guide-card">
                <p>
                  ...
                  شما <strong>فرایندی «نمی‌سازید»</strong>؛ همان‌طور که در دفتر درخواست می‌دادید اینجا درخواست ثبت می‌کنید و مراحل بعدی توسط انیستیتو و طبق مقررات پیش می‌رود.
                </p>
                ...
                <ul>
                  ...
                  <li><strong>کمیته‌ها و سوپرویژن</strong> طبق آیین‌نامه انیستیتو و مرحلهٔ شما باز می‌شوند؛ اگر درخواستی در پنل نمی‌بینید، ممکن است هنوز به آن مرحله نرسیده باشید یا نیاز به هماهنگی حضوری با دفتر باشد.</li>
                </ul>
                ...
                <div className="guide-callout success">
                  ...
                  <div>
                    ...
                    برای مسائل مالی، انضباطی، یا شرایط خاص همیشه با مسیر رسمی انیستیتو هماهنگ کنید.
                  </div>
                </div>
              </div>
            </section>
              ...
              {userRole === 'student' ? (
                <>
                  <FaqItem
                    ...
                    answer="معمولاً به‌خاطر یکی از این موارد است: هنوز فرایند اصلی (مثلاً ثبت‌نام دوره) باز مانده؛ همان نوع درخواست را قبلاً شروع کرده‌اید؛ یا طبق مقررات انیستیتو هنوز به ترم/شرط لازم نرسیده‌اید. روی دکمه بمانید یا متن راهنما را بخوانید؛ در شک، با دفتر تماس بگیرید."
                  />
                  <FaqItem
                  ...
                  <FaqItem
                    ...
                    answer="خیر. شما فرایند نمی‌سازید؛ فقط درخواست‌های از پیش تعریف‌شده توسط انیستیتو را شروع یا ادامه می‌دهید. ساخت و ویرایش فرایندها کار همکاران اداری و فنی است."
                  />
                  <FaqItem
                    question="ورود به سامانه چگونه است؟"
                    answer="ورود معمولی با شماره موبایل ثبت‌شده در پرونده و کد یکبار مصرف پیامکی است. اگر نام کاربری و رمز هم دارید، از همان مسیر اعلام‌شده توسط انیستیتو استفاده کنید."
                  />
                  <FaqItem
