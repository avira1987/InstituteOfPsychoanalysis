...
} from '../utils/liveTherapyObservationTaAttendanceDisplay'

/**
 * داشبورد مدرس — خاتمه درس مشاهده زنده درمان (بخش TA و حضور/مشارکت) — فرایند SOP ۷۴.
 */
export default function LiveTherapyObservationTaAttendancePanel({
  detail = null,
  ...
  return (
    <div
      className="card"
      data-testid="live-therapy-ta-attendance-panel"
    ...
    >
      ...
      <div style={{ padding: compact ? '0 0.75rem 0.75rem' : '0 1rem 1rem' }}>
        ...
        <div
          data-testid="live-therapy-ta-summary"
          style={{
            display: 'grid',
        ...
        <TaAttendanceHintBlock tone="info">
          ...
          گزارش PDF پایانی در فرایند «آپلود گزارش پایانی» (`live_therapy_observation_course_completion`) است.
          وظایف TA از فرایندهای ۴۳–۴۶ تجمیع می‌شود.
        </TaAttendanceHintBlock>
        ...
        {currentState === 'grades_entry' && (
          <>
            ...
            {taRow && (
              <div
                data-testid="live-therapy-ta-row-summary"
                style={{
            ...
            <button
              ...
              data-testid="live-therapy-ta-submit-grades"
