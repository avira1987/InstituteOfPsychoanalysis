...
import {
  ...
  LiveTherapyCompletionUploadBanner,
} from '../utils/liveTherapyObservationCourseCompletionDisplay'
import { parseStepFileUploadValue } from '../utils/uploadPublicUrl'

/**
 * بخش آپلود گزارش پایانی PDF — فرایند ۶۵ (دانشجو).
 */
export default function LiveTherapyObservationFinalReportUploadSection({
  instanceId = null,
  detail = null,
  stepFormValues = {},
  onFieldChange = null,
  ...
  if (stepFormLocked && hasFile) {
    return (
      <div
        data-testid="live-therapy-observation-final-report-upload-section"
        style={{ marginBottom: '0.85rem' }}
      >
        <LiveTherapyCompletionUploadBanner ctx={ctx} />
  ...
  return (
    ...
    >
      <h4 style={{ margin: '0 0 0.5rem', fontSize: '0.92rem', fontWeight: 700, color: '#0f766e' }}>
        آپلود گزارش پایانی
      </h4>

      <LiveTherapyCompletionUploadBanner ctx={ctx} />

      <LiveTherapyCompletionHintBlock tone="warn">
        ...
        <>
          <div className="psf-field" style={{ marginBottom: '0.75rem' }}>
            ...
            <input
              ...
              data-testid="live-therapy-observation-final-report-file-input"
            />
          </div>
          <button
            type="button"
            className="btn btn-primary btn-sm"
            data-testid="live-therapy-observation-final-report-submit"
