...
const STATE_HINTS = {
  ...
  course_selection: 'دروس مجاز ترم دوم را بر اساس نوع پذیرش انتخاب و تأیید کنید (تک‌درس: فقط تئوری روانکاوی ۲؛ کامل/مشروط: تمام دروس ترم ۲؛ درس مردودی ترم ۱ به‌صورت هم‌نیاز قابل اخذ همزمان است).',
