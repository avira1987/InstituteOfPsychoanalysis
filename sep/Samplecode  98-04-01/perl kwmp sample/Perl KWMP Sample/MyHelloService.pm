...
# -- generated from http://192.168.1.22:8080/hello-jaxrpc/hello?WSDL [Mon Oct 20 09:17:00 2003]

my %methods = (
  sayHello => {
    endpoint => 'http://192.168.1.22:8080/hello-jaxrpc/hello',
    soapaction => '',
    uri => 'urn:Foo',
    parameters => [
      SOAP::Data->new(name => 'String_1', type => 'xsd:string', attr => {}),
    ],
  },
);
