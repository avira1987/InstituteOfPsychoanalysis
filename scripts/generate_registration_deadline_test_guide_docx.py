#!/usr/bin/env python3
"""تولید فایل Word راهنمای تست مهلت ثبت‌نام و تقویم آموزشی — راست‌چین با فونت ایران‌سنس.

اجرا از ریشهٔ ریپو:
  python scripts/generate_registration_deadline_test_guide_docx.py

خروجی:
  docs/راهنمای_تست_مهلت_ثبت_نام_و_تقویم_آموزشی.docx
"""
...
OUT_DOCX = ROOT / "docs" / "راهنمای_تست_مهلت_ثبت_نام_و_تقویم_آموزشی.docx"

SOURCES = [
    ROOT / "docs" / "registration_deadline_test_guide_plain_fa.md",
    ROOT / "docs" / "registration_deadline_role_daily_tasks_plain_fa.md",
]
...
def main() -> None:
    ...
    run = cover.add_run("راهنمای تست مهلت ثبت‌نام\nو تقویم آموزشی")
    ...
    sub_run = sub.add_run("شامل: چک‌لیست تست و وظایف روزانه نقش‌ها")
