#!/usr/bin/env python3
"""تولید فایل Word راهنمای تست ورود اتوماسیون — راست‌چین با فونت ایران‌سنس (IRANSans).

اجرا از ریشهٔ ریپو:
  python scripts/generate_institute_onboarding_test_guide_docx.py
...
OUT_DOCX = ROOT / "docs" / "راهنمای_تست_ورود_اتوماسیون_مرکز_انستیتو.docx"

SOURCES = [
    ROOT / "docs" / "institute_onboarding_test_guide_plain_fa.md",
    ROOT / "docs" / "role_daily_tasks_plain_fa.md",
]
...
def main() -> None:
    ...
    run = cover.add_run("راهنمای تست ورود اتوماسیون\nمرکز انستیتو روانکاوی تهران")
    ...
    sub_run = sub.add_run("شامل: چک‌لیست تست فرایندها و وظایف روزانه نقش‌ها")
