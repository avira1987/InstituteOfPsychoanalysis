#!/usr/bin/env python3
"""تولید فایل Word راهنمای تست UI جدید آماده‌سازی ترم — راست‌چین با فونت ایران‌سنس.

اجرا از ریشهٔ ریپو:
  python scripts/generate_semester_prep_ui_test_guide_docx.py

خروجی:
  docs/راهنمای_تست_سریع_آماده_سازی_ترم_UI_جدید.docx
"""
...
OUT_DOCX = ROOT / "docs" / "راهنمای_تست_سریع_آماده_سازی_ترم_UI_جدید.docx"

SOURCES = [
    ROOT / "docs" / "semester_prep_ui_test_guide_plain_fa.md",
    ROOT / "docs" / "semester_prep_ui_role_daily_tasks_plain_fa.md",
]
...
def main() -> None:
    ...
    run = cover.add_run("راهنمای تست سریع\nرابط جدید آماده‌سازی ترم")
    ...
    sub_run = sub.add_run(
        "شامل: فلسفهٔ هر گام، منطق اتوماسیون، چک‌لیست سریع و وظایف روزانه"
    )
