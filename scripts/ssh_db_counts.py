"""Compare remote DB row counts after deploy."""
...
REMOTE_CMD = r"""
docker exec anistito-db psql -U anistito -d anistito -t -c "SELECT 'users='||count(*) FROM users; SELECT 'students='||count(*) FROM students;"
